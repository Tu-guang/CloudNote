...
<div class="col-md-9">
    <div class="data_list">
        <div class="data_list_title"><span class="glyphicon glyphicon-edit"></span>&nbsp;个人
            中心
        </div>
            ...
            <div class="row" style="padding-top: 20px;">
                <div class="col-md-8">
                    ...
                    <form class="form-horizontal" method="post" action="user"
                        ...
                        <input hidden name="actionName" value="updateUser">
                        <div class="form-group">
                            <label for="nickName" class="col-sm-2 control-label">昵称:
                            </label>
                            <div class="col-sm-3">
